...
git clone <url of the ValoToggleButton repository>
mvn clean install
cd demo
mvn jetty:run
...
If you have not already compiled the widgetset, do it now by running vaadin:install Maven target for valo-toggle-button-root project.
...
ValoToggleButton is written by <...>
...
ValoToggleButton JavaDoc is available online at <...>
